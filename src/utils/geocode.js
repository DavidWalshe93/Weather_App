...
const geocode = (address, callback) => {
    ...
    const url = "https://api.mapbox.com/geocoding/v5/mapbox.places/shannon.json?access_token=pk.eyJ1IjoiZHdhbHNoZTkzIiwiYSI6ImNrNjFheXE5dTAxZTcza28wZHhqNWtlZGkifQ.Tan1qtJ79NtS4qK2xgpHSQ&limit=1";
    console.log(url)
